      ...
      <div class="col-md-4 mb-2">
       ...
       <div class="col-md-4 mb-2">
        <button class="btn btn-secondary w-100 rounded-pill category-btn " 
                data-bs-toggle="collapse" data-bs-target="#kvmCards" aria-expanded="true">
          KVM
        </button>
      </div>
    </div>
...
<div class="row g-4" id="productCollapse">
    ...
    <div class="row g-4">
      <div class="col-md-4 d-flex">
        <div class="card shadow-lg flex-fill d-flex flex-column" style="border-radius:24px; min-height:420px;">
          <img src="{{ asset('assets/images/products/vertiv/ups/ups1.png') }}" class="card-img-top" alt="UPS Vertiv">
          <div class="card-body d-flex flex-column">
            <h3 class="card-title">Vertiv GXT5-10KIRT5UXLN</h3>
  ...
  <div class="collapse" id="kvmCards" data-bs-parent="#productCollapse">
    <div class="row g-4">
      <div class="col-md-4 d-flex">
        <div class="card shadow-lg flex-fill d-flex flex-column" style="border-radius:24px; min-height:420px;">
          <img src="{{ asset('assets/images/products/vertiv/kvm/kvm1.png') }}" class="card-img-top" alt="KVM Vertiv">
          <div class="card-body d-flex flex-column">
            <h3 class="card-title">VERTIV CLRA19KMM8A LCD Rack Console KVM</h3>
            <a href="{{ url('/#contact') }}" class="btn btn-danger mt-auto "style="border-radius:12px;">Discuss with us</a>
          </div>
        </div>
      </div>
