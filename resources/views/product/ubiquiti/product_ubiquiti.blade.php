...
<section class="prod">
  <div class="container">
    ...
    <div class="row justify-content-center mb-5" style="max-width: 600px; margin: 0 auto;">
      <div class="col-md-4 mb-2">
        <button class="btn btn-danger w-100 rounded-pill category-btn active" 
                data-bs-toggle="collapse" data-bs-target="#apCards" aria-expanded="true">
          Access Point
        </button>
      </div>
    </div>
    ...
    <div class="row g-4" id="productCollapse">
      ...
      <!-- firewall Collapse -->
      <div class="collapse show" id="apCards" data-bs-parent="#productCollapse">
        <div class="row g-4">
          <div class="col-md-4 d-flex">
            <div class="card shadow-lg flex-fill d-flex flex-column" style="border-radius:24px; min-height:420px;">
              <img src="{{ asset('assets/images/products/ubiquiti/ap/ap1.png') }}" class="card-img-top" alt="Server 1">
              <div class="card-body d-flex flex-column">
                <h3 class="card-title">U6-Lite</h3>
                <a href="{{ url('/#contact') }}" class="btn btn-danger mt-auto rounded-pill">Discuss with us</a>
              </div>
            </div>
          </div>
                    <div class="col-md-4 d-flex">
            <div class="card shadow-lg flex-fill d-flex flex-column" style="border-radius:24px; min-height:420px;">
              <img src="{{ asset('assets/images/products/ubiquiti/ap/ap2.png') }}" class="card-img-top" alt="Server 1">
              <div class="card-body d-flex flex-column">
                <h3 class="card-title">U6-Long Range</h3>
