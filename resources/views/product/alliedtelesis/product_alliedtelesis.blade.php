  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-center mb-4">
      <h1 class="fw-bold mb-5 text-center"
        style="color:black;display:inline-block;border-bottom:3px solid red;padding-bottom:10px;max-width:500px; font-size:32px;">
    ...
    <div class="row justify-content-center mb-5" style="max-width: 600px; margin: 0 auto;">
      <div class="col-md-4 mb-2">
        <button class="btn btn-danger w-100 rounded-pill category-btn active" 
                data-bs-toggle="collapse" data-bs-target="#swCards" aria-expanded="true">
          Switch
        </button>
      </div>
    </div>
    ...
    <div class="row g-4" id="productCollapse">
      ...
      <!-- firewall Collapse -->
      <div class="collapse show" id="swCards" data-bs-parent="#productCollapse">
        <div class="row g-4">
          <div class="col-md-4 d-flex">
            <div class="card shadow-lg flex-fill d-flex flex-column" style="border-radius:24px; min-height:420px;">
              <img src="{{ asset('assets/images/products/alliedtelesis/switch/switch1.png') }}" class="card-img-top" alt="Server 1">
              <div class="card-body d-flex flex-column">
                <h3 class="card-title">AT-GS980MX/52PSm</h3>
