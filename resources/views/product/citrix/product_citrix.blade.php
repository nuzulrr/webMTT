...
<section class="prod">
  <div class="container">
    ...
    <!-- Category Buttons -->
    <div class="row justify-content-center mb-5" style="max-width: 700px; margin: 0 auto;">
      <div class="col-md-3 mb-2">
        <button class="btn btn-danger w-100 rounded-pill category-btn active" 
                data-bs-toggle="collapse" data-bs-target="#moduleCards" aria-expanded="true">
          Load Balancer
        </button>
      </div>
      </div>
    ...
    <div class="row g-4" id="productCollapse">
     ...
     <!-- software Collapse -->
<div class="collapse show" id="moduleCards" data-bs-parent="#productCollapse">
  <div class="row g-4">
